...
struct expression_t make_expr(struct expression_t e1, char* binary_op, struct expression_t e2){
...
void dot_fonction(struct fonction_t fonction){
	...
	for (int i = 0; i < fonction.liste_instructions->size; ++i){
		int index_instruction = dot_instruction(*fonction.liste_instructions->liste[i]);
